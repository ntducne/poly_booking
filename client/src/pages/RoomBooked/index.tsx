            ...
            <div className='min-h-[100px] my-[100px] lg:mx-[150px] mx-2'>
                ...
                <div>
                    <div className='border-t pt-[30px] flex flex-col md:flex-row gap-[30px]'>
                        ...
                        <div className='mb-3'>
                            <h3 className='text-[20px] font-bold mb-3'>Distant Mountains Artwork Tee</h3>
                            <p className='text-[20px] font-bold mb-3'>$36.00</p>
                            <p className='text-[#6B7280] tracking-[1px] text-[16px]'>You awake in a new, mysterious land. Mist hangs low along the distant mountains. What does it mean?</p>
                            <div className='flex mt-[30px] gap-11'>
                                ...
                                <div>
                                    ...
                                    <p className='text-[#6B7280] text-[16px]'>1•••••••••40</p>
                                </div>
                            </div>
                            <Divider />
                            <div className='mt-3'>
                                <h2 className='text-[16px] font-medium'>Processing on March 24, 2021</h2>
                                <div className='flex mt-5 h-[13px] rounded-lg bg-[#E5E7EB]'>
                                    <div className='w-[50%] h-[13px] rounded-lg bg-[#4F46B5]'>
                                        <h2 className='mt-5 font-medium text-[14px] text-[#4F46B5]'>Pending</h2>
                                    </div>
                                    <div className='w-[50%] h-[13px] rounded-lg bg-[#E5E7EB]'>
                                        <h2 className='mt-5 font-medium text-[14px]'>Done</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
