                        ...
                        <div className="grid md:grid-cols-2">
                            <div className="h-full pr-6">
                                <p className="mt-3 mb-12 text-lg text-gray-600 ">
                                    Chúng tôi luôn sẵn lòng lắng nghe và
                                    hành cùng quý khách hàng. Đừng ngần
                                    liên hệ với chúng tôi để được tư vấn
                                    hoặc đặt phòng. Chúng tôi cam kết cung
                                    cấp dịch vụ chăm sóc khách hàng tận
                                    tâm, mang lại cho bạn trải nghiệm lưu
                                    trú không giới hạn. Hãy để chúng tôi
                                ...
                                <ul className="mb-6 md:mb-0">
                                    <li className="flex">
                                        ...
                                        <div className="ml-4 mb-4">
                                            <h3 className="mb-2 text-lg font-medium leading-6 text-gray-900 ">Địa chỉ
                                            </h3>
                                    ...
                                    <li className="flex">
                                        ...
                                        <div className="ml-4 mb-4">
                                            <h3 className="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Thông tin
                                            </h3>
                                            <p className="text-gray-600 ">Mobile: +84 123456789</p>
                                            <p className="text-gray-600 ">Mail: PolyDevHotel@gmail.com</p>
                                        </div>
                                    </li>
                                    <li className="flex">
                                        <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                                        ...
                                        <div className="ml-4 mb-4">
                                            ...
                                            <p className="text-gray-600 ">Thứ 7 &amp; Chủ Nhật: 08:00 - 12:00</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
