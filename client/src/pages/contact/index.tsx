            ...
            <div className="grid md:grid-cols-2">
              <div className="h-full pr-6">
                <p className="mt-3 mb-12 text-lg text-gray-600 ">
                  Chúng tôi luôn sẵn lòng lắng nghe và hành cùng quý khách hàng.
                  Đừng ngần liên hệ với chúng tôi để được tư vấn hoặc đặt phòng.
                  Chúng tôi cam kết cung cấp dịch vụ chăm sóc khách hàng tận
                  tâm, mang lại cho bạn trải nghiệm lưu trú không giới hạn. Hãy
                  để chúng tôi chia sẻ niềm vui của bạn!
                </p>
