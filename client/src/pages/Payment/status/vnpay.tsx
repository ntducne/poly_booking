...
export default function StatusPaymentVnpay() {
            ...
            {status == 6 && (
                <div className="container px-4 mx-auto" data-path="0.0">
                    <Result
                        ...
                        subTitle="Quý khách huỷ thanh toán đặt phòng !"
                        extra={[
                            <Link to="/" type="button" key="buy">
                                Về trang chủ
                            </Link>,
            ...
            {status == 7 && (
                <div className="container px-4 mx-auto" data-path="0.0">
                    <Result
                        status="error"
                        title="Đặt phòng thất bại !"
                        subTitle="Lỗi thanh toán ! Vui lòng liên hệ với chúng tôi để được hỗ trợ."
                        extra={[
