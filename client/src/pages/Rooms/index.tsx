...
export default function Rooms({}: Props) {
  ...
  const [paginationSize, setPaginationSize] = useState<any>("default");
  ...
  useEffect(() => {
    ...
    handleResize(); // Khi trang được tải, kiểm tra kích thước màn hình ban đầu
      ...
      <div className="pb-[100px] bg-bgr">
        ...
        <div className="pt-primary px-4 ">
          ...
          <div className="flex justify-end">
            <Pagination size={paginationSize} defaultCurrent={6} total={500} />
          </div>
        </div>
